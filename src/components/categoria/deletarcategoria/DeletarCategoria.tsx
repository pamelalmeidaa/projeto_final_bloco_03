  ...
  return (
    <div className="container w-1/3 mx-auto">
      ...
      <div className="border flex flex-col rounded-2xl overflow-hidden justify-between shadow-lg">
        ...
        <div className="flex">
          <button
            className="text-white bg-red-500 hover:bg-red-700 w-full py-2 transition-colors duration-200"
            onClick={retornar}
          >
            Não
          </button>
          <button
            className="w-full text-white bg-green-500 hover:bg-green-700 flex items-center justify-center transition-colors duration-200"
